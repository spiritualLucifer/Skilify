...
import BannerImage1 from "../assets/Images/a1.jpg"
import BannerImage2 from "../assets/Images/a2.webp"
import BannerImage3 from "../assets/Images/a3.jpg"
    ...
    <div>
      <section className="bg-pink-25">
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%] text-richblack-900">
            Driving Innovation in Online Education for a
            <HighlightText text={"Brighter Future"} />
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-600 lg:w-[95%]">
              Skillify is at the forefront of driving innovation in online
      ...
      <StatsComponenet />
      <section className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-800 bg-richblue-300">
        <LearningGrid />
        <ContactFormSection />
      </section>
